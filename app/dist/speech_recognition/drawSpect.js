...
exports.drawSpect = void 0;
const sharp = require("sharp");
const ft = require("fourier-transform");
var db = require('decibels');
const outputFile = __dirname + "/../../../test.png";
var chunks = [];
async function drawSpect(buffer) {
    chunks.push(buffer);
    if (chunks.length > 3)
        chunks = chunks.slice(chunks.length - 4);
    ...
    console.log({ size });
    var spectrum = ft(data16.slice(0, size));
    let height = 128;
